...
public class PacketCodec {
    ...
    private PacketCodec() {
        ...
        packetTypeMap.put(Command.LIST_GROUP_REQUEST, ListGroupMembersRequestPacket.class);
        packetTypeMap.put(Command.LIST_GROUP_RESPONSE, ListGroupMembersResponsePacket.class);
